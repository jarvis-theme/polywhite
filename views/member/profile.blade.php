                    ...
                    <div class="content">
                      <table class="form">
                        <tbody><tr>
                          ...
                          <td><input style="width:80%" type="text" name="nama" value="{{$user->nama}}" required>
                            </td>
                        </tr>
                        <tr>
                          <td><span class="required">*</span> E-Mail:</td>
                          <td><input style="width:80%" type="text" name='email' value='{{$user->email}}' required>
                            </td>
                        </tr>
                        <tr>
                          <td><span class="required">*</span> Telephone:</td>
                          <td><input style="width:80%" type="text" name='telp' value='{{$user->telp}}' required>
                            </td>
                        </tr>
                      </tbody></table>
                    </div>
                    ...
                    <div class="content">
                      <table class="form">
                        ...
                        <tr>
                          ...
                          <td><textarea style="width:80%" name='alamat' required>{{$user->alamat}}</textarea> 
                            </td>
                        </tr>
                        <tr>
                          <td><span id="postcode-required" class="required">*</span> Kode Pos:</td>
                          <td><input style="width:80%" type="text" name='kodepos' value='{{$user->kodepos}}'>
                            </td>
                        </tr>
                        <tr>
