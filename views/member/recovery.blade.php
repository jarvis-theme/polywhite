        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-lg-9 main">
                <div class="section">
                    ...
                    <tbody><tr>
                      <td>Password baru:</td>
                      <td><input type="password" placeholder="password baru" name="password" value="" required></td>
                    </tr>
                    <tr>
                      <td>Konfirmasi password baru:</td>
                      <td><input type="password" placeholder="ulangi password baru" name="password_confirmation" value="" required></td>
                    </tr>
                    </tbody></table>
                    </div>
                    <div class="buttons">
