                    ...
                    <div class="content">
                      <table class="form">
                        <tbody><tr>
                          ...
                          <td><input style="width:80%" type="text" name="nama" value="{{Input::old('nama')}}" required>
                            </td>
                        </tr>
                        <tr>
                          <td><span class="required">*</span> E-Mail:</td>
                          <td><input style="width:80%" type="text" name='email' value='{{Input::old("email")}}' required>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="content">
                      <table class="form">
                        ...
                        <tr>
                          ...
                          <td><textarea style="width:80%" name='alamat' required>{{Input::old("alamat")}}</textarea> 
                            </td>
                        </tr>
                        <tr>
                          <td><span id="postcode-required" class="required">*</span> Kode Pos:</td>
                          <td><input style="width:80%" type="text" name='kodepos' value='{{Input::old("kodepos")}}'>
                            </td>
                        </tr>
                        <tr>
