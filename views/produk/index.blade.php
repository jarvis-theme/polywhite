                        ...
                        <div class="mix col-xs-12 col-sm-6 col-lg-4">
                            <div class="product"  data-name="'Demo Product1'"   >
                                <a href="{{product_url($myproduk)}}" class="product-link clearfix">
                                    ...
                                    @endif
                                    <div class="product-thumbnail">
                                        {{HTML::image(product_image_url($myproduk->gambar1),'produk',array('title'=>'product','style'=>'min-height: 199px'))}}
                                    </div>
                                </a>
                                ...
                                <div class="product-info clearfix">
                                    ...
                                    <div class="details">
                                        <div class="product-price">
                                            ...
                                            <span class="price-old">{{price($myproduk->hargaCoret,$matauang)}}</span>@endif 
